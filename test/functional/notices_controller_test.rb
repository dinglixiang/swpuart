...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { ncontent: @notice.ncontent, nfilenumber: @notice.nfilenumber, ntitle: @notice.ntitle }
    end
  ...
  test "should update notice" do
    put :update, id: @notice, notice: { ncontent: @notice.ncontent, nfilenumber: @notice.nfilenumber, ntitle: @notice.ntitle }
    assert_redirected_to notice_path(assigns(:notice))
  end
